...
Fluid.plugins = {
  ...
  codeWidget() {
    ...
    jQuery('.markdown-body pre').each(function() {
      ...
      var resultHtml = copyTmpl.replace('LANG', lang).replace('code-widget">',
      getBgClass($pre[0]) + (enableCopy ? ' code-widget copy-btn" data-clipboard-snippet><i class="iconfont icon-copy"></i>' : ' code-widget">'))
      $pre.append(resultHtml);

      if (CONFIG.fold_btn) {
        $pre.append('<i class="iconfont icon-arrowdown icon-code-fold" type="button"></i>');
        var width = $pre.find('.code-widget').width();
        $pre.find('.icon-code-fold').css('right', width+'px');
      }
