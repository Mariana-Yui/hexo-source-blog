<div class="list-group">
  <p class="h5">
    <span class="label label-primary"><%= __(params.key + '.post_total', params.postTotal) %></span>
    <span class="label label-success"><%= __(params.key + '.wordcount_total', wordcount(params)) %></span>
  </p>
  <hr>
  <% var dateCursor %>
