  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          if (!((stream_1_1 = _b.sent()), !stream_1_1.done))
            return [3 /*break*/, 5];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(this.settings.uploadServer, {
                method: "POST",
  ...
  PicGoCoreUploader.prototype.uploadByClipHandler = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.uploadByClip()];
          case 1:
            res = _a.sent();
            splitList = res.split("\n");
  ...
  PicGoCoreUploader.prototype.exec = function (command) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, child_process.exec(command)];
          case 1:
...
var Helper = /** @class */ (function () {
  ...
  Helper.prototype.getFrontmatterValue = function (key, defaultValue) {
    ...
    if (
      ...
      cache.frontmatter.hasOwnProperty(key)
    ) {
    ...
    try {
      ...
      try {
        if (
          WikiMatches_1_1 &&
          !WikiMatches_1_1.done &&
          (_b = WikiMatches_1.return)
        )
          _b.call(WikiMatches_1);
      } finally {
...
var imageAutoUploadPlugin = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            (fileArray_1 = __values(fileArray)),
          ...
          case 2:
            ...
            (_a = __read(
              [
                decodeURI(path.parse(asset).name).replaceAll(
                  /[\\\\/:*?\"<>|]/g,
                  "-"
                ),
            ...
            return [
              4 /*yield*/,
              this.download(url, path.join(folderPath, "" + name_1 + ext)),
            ];
          case 3:
            response = _c.sent();
            if (response.ok) {
              activeFolder = this.app.vault.getAbstractFileByPath(
              ...
              imageArray.push({
                ...
                path: obsidian.normalizePath(
                  path.relative(abstractActiveFolder, response.path)
                ),
              });
            }
            _c.label = 4;
  ...
  imageAutoUploadPlugin.prototype.getFileAssetPath = function () {
    ...
    var activeFile = this.app.vault.getAbstractFileByPath(
      this.app.workspace.getActiveFile().path
    );
    // 当前文件夹下的子文件夹
    if (assetFolder.startsWith("./")) {
      var activeFolder = decodeURI(
        path.resolve(basePath, activeFile.parent.path)
      );
                  ...
                  var value = _this.helper
                    ...
                    .replaceAll(
                      encodeURI(
                        path
                          .relative(
                            _this.app.workspace.getActiveFile().parent.path,
                            file.path
                          )
                          .replaceAll("\\", "/")
                      ),
  ...
  imageAutoUploadPlugin.prototype.uploadAllFile = function () {
    ...
    var thisPath = this.app.vault.getAbstractFileByPath(
      this.app.workspace.getActiveFile().path
    );
    var basePath = this.app.vault.adapter.getBasePath();
    var imageList = [];
    ...
    try {
      for (
        var fileArray_2 = __values(fileArray),
          fileArray_2_1 = fileArray_2.next();
        !fileArray_2_1.done;
        fileArray_2_1 = fileArray_2.next()
      ) {
        ...
        if (!encodedUri.startsWith("http")) {
          ...
          if (encodedUri.startsWith(".")) {
            abstractImageFile = decodeURI(
              path.join(
                basePath,
                path.posix.resolve(
                  path.posix.join("/", thisPath.parent.path),
                  encodedUri
                )
              )
            );
          ...
          if (
            fs.existsSync(abstractImageFile) &&
  ...
  imageAutoUploadPlugin.prototype.setupPasteHandler = function () {
    ...
    this.registerEvent(
      this.app.workspace.on(
        "editor-paste",
        function (evt, editor, markdownView) {
          var allowUpload = _this.helper.getFrontmatterValue(
            "image-auto-upload",
            _this.settings.uploadByClipSwitch
          );
          ...
          if (
            ...
            _this
              .uploadFileAndEmbedImgurImage(editor, function (editor, pasteId) {
                return __awaiter(_this, void 0, void 0, function () {
                  var res, url;
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        ...
                        return [
                          4 /*yield*/,
                          this.picGoUploader.uploadFileByClipboard(),
                        ];
                      case 1:
                        res = _a.sent();
                        return [3 /*break*/, 4];
                      case 2:
                        if (!(this.settings.uploader === "PicGo-Core"))
                          return [3 /*break*/, 4];
                        return [
                          4 /*yield*/,
                          this.picGoCoreUploader.uploadByClipHandler(),
                        ];
                      case 3:
                        res = _a.sent();
                        _a.label = 4;
        ...
        function (evt, editor, markdownView) {
          return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  allowUpload = this.helper.getFrontmatterValue(
                    "image-auto-upload",
                  ...
                  return [
                    4 /*yield*/,
                    this.picGoUploader.uploadFiles(sendFiles_1),
                  ];
                case 1:
                  data = _a.sent();
                  if (data.success) {
                    data.result.map(function (value) {
                      var pasteId = (Math.random() + 1)
                        .toString(36)
                        .substr(2, 5);
  ...
  imageAutoUploadPlugin.prototype.uploadFileAndEmbedImgurImage = function (
    editor,
    callback
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  imageAutoUploadPlugin.prototype.insertTemporaryText = function (
    editor,
    pasteId
  ) {
  ...
  imageAutoUploadPlugin.prototype.embedMarkDownImage = function (
    editor,
    pasteId,
    imageUrl
  ) {
  ...
  imageAutoUploadPlugin.prototype.handleFailedUpload = function (
    editor,
    pasteId,
    reason
  ) {
  ...
  imageAutoUploadPlugin.replaceFirstOccurrence = function (
    editor,
    target,
    replacement
  ) {
